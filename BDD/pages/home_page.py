        ...
        try:
            ...
            try:
                ...
                if error_element.is_displayed():
                    ...
                    screenshot_path = ScreenshotUtil.capture_screenshot(self.driver, f"Search_Invalid_{search_text}")
                    allure.attach.file(screenshot_path, name=f"Search_Invalid_{search_text}", attachment_type=allure.attachment_type.PNG)
                    return "error"
